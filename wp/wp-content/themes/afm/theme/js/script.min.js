(() => {
  ...
  !function(e4) {
    "function" == typeof define && define.amd ? define(e4) : e4();
  }(function() {
    "use strict";
    const e4 = "5.3.2", t4 = 10, n3 = "data-iframe-size", o4 = "data-overflowed", i4 = "bottom", r4 = "right", a4 = "resizeParent", l5 = (e5, t5, n4, o5) => e5.addEventListener(t5, n4, o5 || false), s5 = ["<iy><yi>Puchspk Spjluzl Rlf</><iy><iy>", "<iy><yi>Tpzzpun Spjluzl Rlf</><iy><iy>", "Aopz spiyhyf pz hchpshisl dpao ivao Jvttlyjphs huk Vwlu-Zvbyjl spjluzlz.<iy><iy><i>Jvttlyjphs Spjluzl</><iy>Mvy jvttlyjphs bzl, <p>pmyhtl-ylzpgly</> ylxbpylz h svd jvza vul aptl spjluzl mll. Mvy tvyl pumvythapvu cpzpa <b>oaawz://pmyhtl-ylzpgly.jvt/wypjpun</>.<iy><iy><i>Vwlu Zvbyjl Spjluzl</><iy>Pm fvb hyl bzpun aopz spiyhyf pu h uvu-jvttlyjphs vwlu zvbyjl wyvqlja aolu fvb jhu bzl pa mvy myll bukly aol alytz vm aol NWS C3 Spjluzl. Av jvumpyt fvb hjjlwa aolzl alytz, wslhzl zla aol <i>spjluzl</> rlf pu <p>pmyhtl-ylzpgly</> vwapvuz av <i>NWSc3</>.<iy><iy>Mvy tvyl pumvythapvu wslhzl zll: <b>oaawz://pmyhtl-ylzpgly.jvt/nws</>", "<i>NWSc3 Spjluzl Clyzpvu</><iy><iy>Aopz clyzpvu vm <p>pmyhtl-ylzpgly</> pz ilpun bzlk bukly aol alytz vm aol <i>NWS C3</> spjluzl. Aopz spjluzl hssvdz fvb av bzl <p>pmyhtl-ylzpgly</> pu Vwlu Zvbyjl wyvqljaz, iba pa ylxbpylz fvby wyvqlja av il wbispj, wyvcpkl haaypibapvu huk il spjluzlk bukly clyzpvu 3 vy shaly vm aol NUB Nlulyhs Wbispj Spjluzl.<iy><iy>Pm fvb hyl bzpun aopz spiyhyf pu h uvu-vwlu zvbyjl wyvqlja vy dlizpal, fvb dpss ullk av wbyjohzl h svd jvza vul aptl jvttlyjphs spjluzl.<iy><iy>Mvy tvyl pumvythapvu cpzpa <b>oaawz://pmyhtl-ylzpgly.jvt/wypjpun</>."];
    Object.fromEntries(["2cgs7fdf4xb", "1c9ctcccr4z", "1q2pc4eebgb", "ueokt0969w", "w2zxchhgqz", "1umuxblj2e5"].map((e5, t5) => [e5, Math.max(0, t5 - 1)]));
    const c4 = (e5) => ((e6) => e6.replaceAll(/[A-Za-z]/g, (e7) => String.fromCodePoint((e7 <= "Z" ? 90 : 122) >= (e7 = e7.codePointAt(0) + 19) ? e7 : e7 - 26)))(s5[e5]), d5 = (e5) => e5, u4 = 1e5, m2 = (e5) => Math.round(e5 * u4) / u4;
    let f4 = "", p4 = false;
    const h4 = (e5) => {
      f4 = e5.id, p4 = e5.logging;
    }, y4 = (e5) => "" != `${e5}` && void 0 !== e5;
    const g3 = (...e5) => [`[iframe-resizer][${f4 || "child"}]`, ...e5].join(" "), b3 = (...e5) => p4 && console?.info(`%c[iframe-resizer][${f4}]%c`, "font-weight: bold;", "font-weight: normal;", ...e5), v5 = (...e5) => console?.warn(g3(...e5)), w4 = (...e5) => console?.warn((/* @__PURE__ */ ((e6) => (t5) => window.chrome ? e6(t5.replaceAll("<br>", "\n").replaceAll("<rb>", "\x1B[31;1m").replaceAll("</>", "\x1B[m").replaceAll("<b>", "\x1B[1m").replaceAll("<i>", "\x1B[3m").replaceAll("<u>", "\x1B[4m")) : e6(t5.replaceAll("<br>", "\n").replaceAll(/<[/a-z]+>/gi, "")))(g3))(...e5)), z3 = (e5) => w4(e5), S2 = (e5) => {
      const t5 = e5.side || i4, n4 = e5.onChange || d5, r5 = { root: e5.root, rootMargin: "0px", threshold: 1 };
      function a5() {
        const e6 = document.querySelectorAll(`[${o4}]`);
        n4(e6);
      }
      const l6 = new IntersectionObserver(function(e6) {
        for (const n5 of e6) {
          const { boundingClientRect: e7, rootBounds: i5, target: r6 } = n5, a6 = e7[t5], l7 = 0 === a6 || a6 > i5[t5];
          r6.toggleAttribute(o4, l7);
        }
        requestAnimationFrame(a5);
      }, r5), s6 = /* @__PURE__ */ new WeakSet();
      return function(e6) {
        for (const t6 of e6)
          t6.nodeType !== Node.ELEMENT_NODE || s6.has(t6) || (l6.observe(t6), s6.add(t6));
      };
    }, E3 = "--ifr-start", j3 = "--ifr-end", $2 = "--ifr-measure", C3 = [], T3 = /* @__PURE__ */ new WeakSet(), M2 = (e5) => "object" == typeof e5 && T3.add(e5);
    let O2 = null, P2 = {};
    const A3 = setInterval(() => {
      if (C3.length < 10)
        return;
      if (P2.hasTags && P2.len < 25)
        return;
      C3.sort();
      const e5 = Math.min(C3.reduce((e6, t5) => e6 + t5, 0) / C3.length, C3[Math.floor(C3.length / 2)]);
      e5 <= 4 || (clearInterval(A3), w4(`<rb>Performance Warning</>

Calculating the page size is taking an excessive amount of time (${m2(e5)}ms).

To improve performance add the <b>data-iframe-size</> attribute to the ${P2.Side.toLowerCase()} most element on the page. For more details see: <u>https://iframe-resizer.com/perf</>.`));
    }, 5e3);
    function N2(e5) {
      e5.getEntries().forEach((e6) => {
        if (e6.name === j3) {
          const { duration: t5 } = performance.measure($2, E3, j3);
          !function(e7, t6) {
            const { Side: n4, len: o5, hasTags: i5, logging: r5 } = e7;
            P2 = e7, T3.has(O2) || i5 && o5 <= 1 || (r5 || M2(O2), b3(`
  ${n4} position calculated from:`, O2, `
  Parsed ${o5} ${i5 ? "tagged" : "potentially overflowing"} elements in ${m2(t6)}ms`));
          }(e6.detail, t5), C3.push(t5), C3.length > 100 && C3.shift();
        }
      });
    }
    function I2() {
      new PerformanceObserver(N2).observe({ entryTypes: ["mark"] }), M2(document.documentElement), M2(document.body);
    }
    "undefined" != typeof document && "undefined" != typeof PerformanceObserver && ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", I2) : I2()), "undefined" != typeof window && function() {
      const o5 = { contentVisibilityAuto: true, opacityProperty: true, visibilityProperty: true }, s6 = { height: () => (v5("Custom height calculation function not defined"), Le.auto()), width: () => (v5("Custom width calculation function not defined"), Be.auto()) }, u5 = { bodyOffset: 1, bodyScroll: 1, offset: 1, documentElementOffset: 1, documentElementScroll: 1, boundingClientRect: 1, max: 1, min: 1, grow: 1, lowestElement: 1 }, f5 = 128, p5 = {}, g4 = "checkVisibility" in window, b4 = "auto", $3 = "[iFrameSizer]", C4 = $3.length, T4 = { max: 1, min: 1, bodyScroll: 1, documentElementScroll: 1 }, M3 = "scroll";
      let P3, A4, N3, I3, k3, R = true, x3 = "", q3 = 0, L2 = "", B3 = "", D2 = true, W = false, U = true, F2 = false, V2 = false, J = 1, H = b4, Z = true, _5 = "", Q = {}, X = false, Y = 0, G2 = false, K = "", ee = d5, te = [], ne = "child", oe = null, ie = false, re = "", ae = [], le = window.parent, se = "*", ce = 0, de = false, ue = "", me = 1, fe = M3, pe = window, he = () => {
        v5("onMessage function not defined");
      }, ye = () => {
      }, ge = null, be = null;
      function ve() {
        var o6, d6, u6;
        !function() {
          const e5 = (e6) => "true" === e6, t5 = _5.slice(C4).split(":");
          K = t5[0], q3 = void 0 === t5[1] ? q3 : Number(t5[1]), W = void 0 === t5[2] ? W : e5(t5[2]), X = void 0 === t5[3] ? X : e5(t5[3]), R = void 0 === t5[6] ? R : e5(t5[6]), L2 = t5[7], H = void 0 === t5[8] ? H : t5[8], x3 = t5[9], B3 = t5[10], ce = void 0 === t5[11] ? ce : Number(t5[11]), Q.enable = void 0 !== t5[12] && e5(t5[12]), ne = void 0 === t5[13] ? ne : t5[13], fe = void 0 === t5[14] ? fe : t5[14], G2 = void 0 === t5[15] ? G2 : e5(t5[15]), P3 = void 0 === t5[16] ? P3 : Number(t5[16]), A4 = void 0 === t5[17] ? A4 : Number(t5[17]), D2 = void 0 === t5[18] ? D2 : e5(t5[18]), t5[19], ue = t5[20] || ue, Y = void 0 === t5[21] ? Y : Number(t5[21]);
        }(), h4({ id: K, logging: X }), function() {
          function e5(e6) {
            he = e6?.onMessage || he, ye = e6?.onReady || ye, "number" == typeof e6?.offset && (w4("<rb>Deprecated option</>\n\n The <b>offset</> option has been renamed to <b>offsetSize</>. Use of the old name will be removed in a future version of <i>iframe-resizer</>."), D2 && (P3 = e6?.offset), W && (A4 = e6?.offset)), "number" == typeof e6?.offsetSize && (D2 && (P3 = e6?.offsetSize), W && (A4 = e6?.offsetSize)), Object.prototype.hasOwnProperty.call(e6, "sizeSelector") && (re = e6.sizeSelector), se = e6?.targetOrigin || se, H = e6?.heightCalculationMethod || H, fe = e6?.widthCalculationMethod || fe;
          }
          function t5(e6, t6) {
            return "function" == typeof e6 && (s6[t6] = e6, e6 = "custom"), e6;
          }
          if (1 === Y)
            return;
          const n4 = window.iframeResizer || window.iFrameResizer;
          "object" == typeof n4 && (e5(n4), H = t5(H, "height"), fe = t5(fe, "width"));
        }(), function() {
          try {
            ie = "iframeParentListener" in window.parent;
          } catch (e5) {
          }
        }(), Y < 0 ? z3(`${c4(Y + 2)}${c4(2)}`) : ue.codePointAt(0) > 4 || Y < 2 && z3(c4(3)), ue && "" !== ue && "false" !== ue ? ue !== e4 && w4(`<b>Version mismatch</>

The parent and child pages are running different versions of <i>iframe resizer</>.

Parent page: ${ue} - Child page: ${e4}.
`) : w4("<rb>Legacy version detected on parent page</>\n\nDetected legacy version of parent page script. It is recommended to update the parent page to use <b>@iframe-resizer/parent</>.\n\nSee <u>https://iframe-resizer.com/setup/</> for more details.\n"), Te(), Me(), function() {
          let e5 = false;
          const t5 = (t6) => document.querySelectorAll(`[${t6}]`).forEach((o7) => {
            e5 = true, o7.removeAttribute(t6), o7.toggleAttribute(n3, true);
          });
          t5("data-iframe-height"), t5("data-iframe-width"), e5 && w4("<rb>Deprecated Attributes</>\n          \nThe <b>data-iframe-height</> and <b>data-iframe-width</> attributes have been deprecated and replaced with the single <b>data-iframe-size</> attribute. Use of the old attributes will be removed in a future version of <i>iframe-resizer</>.");
        }(), ze(), D2 !== W && (ee = S2({ onChange: we, root: document.documentElement, side: D2 ? i4 : r4 })), 1 !== Y && (pe.parentIframe = Object.freeze({ autoResize: (e5) => (true === e5 && false === R ? (R = true, Ue("autoResizeEnabled", "Auto Resize enabled")) : false === e5 && true === R && (R = false), He(0, 0, "autoResize", JSON.stringify(R)), R), close() {
          He(0, 0, "close");
        }, getId: () => K, getOrigin: () => N3, getPageInfo(e5) {
          if ("function" == typeof e5)
            return ge = e5, He(0, 0, "pageInfo"), void w4("<rb>Deprecated Method</>\n          \nThe <b>getPageInfo()</> method has been deprecated and replaced with  <b>getParentProps()</>. Use of this method will be removed in a future version of <i>iframe-resizer</>.\n");
          ge = null, He(0, 0, "pageInfoStop");
        }, getParentProps(e5) {
          if ("function" != typeof e5)
            throw new TypeError("parentIframe.getParentProps(callback) callback not a function");
          return be = e5, He(0, 0, "parentInfo"), () => {
            be = null, He(0, 0, "parentInfoStop");
          };
        }, getParentProperties(e5) {
          w4("<rb>Renamed Method</>\n          \nThe <b>getParentProperties()</> method has been renamed <b>getParentProps()</>. Use of the old name will be removed in a future version of <i>iframe-resizer</>.\n"), this.getParentProps(e5);
        }, moveToAnchor(e5) {
          Q.findTarget(e5);
        }, reset() {
          Je();
          ...
          He(t5, e5, "scrollTo");
        }, scrollToOffset(e5, t5) {
          He(t5, e5, "scrollToOffset");
        }, sendMessage(e5, t5) {
          He(0, 0, "message", JSON.stringify(e5), t5);
        }, setHeightCalculationMethod(e5) {
          H = e5, Te();
        }, setWidthCalculationMethod(e5) {
          fe = e5, Me();
        }, setTargetOrigin(e5) {
          se = e5;
        }, resize(e5, t5) {
          Ue(a4, `parentIframe.resize(${e5 || ""}${t5 ? `,${t5}` : ""})`, e5, t5);
        }, size(e5, t5) {
          w4("<rb>Deprecated Method</>\n          \nThe <b>size()</> method has been deprecated and replaced with  <b>resize()</>. Use of this method will be removed in a future version of <i>iframe-resizer</>.\n"), this.resize(e5, t5);
        } }), pe.parentIFrame = pe.parentIframe), function() {
          function e5(e6) {
            He(0, 0, e6.type, `${e6.screenY}:${e6.screenX}`);
          }
          function t5(t6, n4) {
            l5(window.document, t6, e5);
          }
          true === G2 && (t5("mouseenter"), t5("mouseleave"));
        }(), Q = function() {
          const e5 = () => ({ x: document.documentElement.scrollLeft, y: document.documentElement.scrollTop });
          function n4(n5) {
            const o8 = n5.getBoundingClientRect(), i6 = e5();
            return { x: parseInt(o8.left, t4) + parseInt(i6.x, t4), y: parseInt(o8.top, t4) + parseInt(i6.y, t4) };
          }
          function o7(e6) {
            function t5(e7) {
              const t6 = n4(e7);
              He(t6.y, t6.x, "scrollToOffset");
            }
            const o8 = e6.split("#")[1] || e6, i6 = decodeURIComponent(o8), r6 = document.getElementById(i6) || document.getElementsByName(i6)[0];
            void 0 === r6 ? He(0, 0, "inPageLink", `#${o8}`) : t5(r6);
          }
          function i5() {
            const { hash: e6, href: t5 } = window.location;
            "" !== e6 && "#" !== e6 && o7(t5);
          }
          function r5() {
            for (const e6 of document.querySelectorAll('a[href^="#"]'))
              "#" !== e6.getAttribute("href") && l5(e6, "click", (t5) => {
                t5.preventDefault(), o7(e6.getAttribute("href"));
              });
          }
          function a5() {
            l5(window, "hashchange", i5);
          }
          function s7() {
            setTimeout(i5, f5);
          }
          ...
          return Q.enable && (1 === Y ? w4("In page linking requires a Professional or Business license. Please see https://iframe-resizer.com/pricing for more details.") : c5()), { findTarget: o7 };
        }(), Se(ke(document)()), void 0 === L2 && (L2 = `${q3}px`), Ee("margin", (d6 = "margin", (u6 = L2).includes("-") && (v5(`Negative CSS value ignored for ${d6}`), u6 = ""), u6)), Ee("background", x3), Ee("padding", B3), function() {
          const e5 = document.createElement("div");
          e5.style.clear = "both", e5.style.display = "block", e5.style.height = "0", document.body.append(e5);
        }(), function() {
          const e5 = (e6) => e6.style.setProperty("height", "auto", "important");
          e5(document.documentElement), e5(document.body);
        }(), je(), Ue("init", "Init message from host page", void 0, void 0, e4), document.title && "" !== document.title && He(0, 0, "title", document.title), $e({ method: o6 = "add", eventType: "After Print", eventName: "afterprint" }), $e({ method: o6, eventType: "Before Print", eventName: "beforeprint" }), $e({ method: o6, eventType: "Ready State Change", eventName: "readystatechange" }), function() {
          const e5 = /* @__PURE__ */ new Set();
          let t5 = false, n4 = 0, o7 = [];
          const i5 = (t6) => {
            for (const n5 of t6) {
              const { addedNodes: t7, removedNodes: o8 } = n5;
              for (const n6 of t7)
                e5.add(n6);
              for (const t8 of o8)
                e5.delete(t8);
          ...
          let s7 = 1;
          function c5() {
            const d8 = performance.now(), u8 = d8 - n4;
            if (u8 > r5 * s7++ + a5 && u8 < l6)
              return setTimeout(c5, r5 * s7), void (n4 = d8);
            s7 = 1, o7.forEach(i5), o7 = [], 0 !== e5.size ? (je(), ze(), Se(e5), e5.forEach(Ae), e5.clear(), t5 = false) : t5 = false;
          }
          function d7(e6) {
            o7.push(e6), t5 || (n4 = performance.now(), t5 = true, requestAnimationFrame(c5));
          }
          function u7() {
            const e6 = new window.MutationObserver(d7), t6 = document.querySelector("body"), n5 = { attributes: false, attributeOldValue: false, characterData: false, characterDataOldValue: false, childList: true, subtree: true };
            return e6.observe(t6, n5), e6;
          }
          u7();
        }(), oe = new ResizeObserver(Oe), oe.observe(document.body), Pe.add(document.body), Ae(document.body), setTimeout(ye);
      }
      function we(e5) {
        te = e5, F2 = te.length > 0, Ue("overflowChanged", "Overflow updated");
      }
      function ze() {
        ae = document.querySelectorAll(`[${n3}]`), V2 = ae.length > 0;
      }
      function Se(e5) {
        V2 || ee(e5);
      }
      function Ee(e5, t5) {
        void 0 !== t5 && "" !== t5 && "null" !== t5 && document.body.style.setProperty(e5, t5);
      }
      function je() {
        if ("" !== re)
          for (const e5 of document.querySelectorAll(re))
            e5.dataset.iframeSize = true;
      }
      function $e(e5) {
        ({ add(t5) {
          function n4() {
            Ue(e5.eventName, e5.eventType);
          }
          p5[t5] = n4, l5(window, t5, n4, { passive: true });
        }, remove(e6) {
          const t5 = p5[e6];
          var n4, o6;
          delete p5[e6], n4 = e6, o6 = t5, window.removeEventListener(n4, o6, false);
        } })[e5.method](e5.eventName);
      }
      function Ce(e5, t5, n4, o6) {
        return t5 !== e5 && (e5 in n4 || (v5(`${e5} is not a valid option for ${o6}CalculationMethod.`), e5 = t5), e5 in u5 && w4(`<rb>Deprecated ${o6}CalculationMethod (${e5})</>

This version of <i>iframe-resizer</> can auto detect the most suitable ${o6} calculation method. It is recommended that you remove this option.`)), e5;
      }
      function Te() {
        H = Ce(H, b4, Le, "height");
      }
      function Me() {
        fe = Ce(fe, M3, Be, "width");
      }
      function Oe(e5) {
        Array.isArray(e5) && 0 !== e5.length && Ue("resizeObserver", `Resize Observed: ${function(e6) {
          switch (true) {
            case !y4(e6):
              return "";
            case y4(e6.id):
              return `${e6.nodeName.toUpperCase()}#${e6.id}`;
            case y4(e6.name):
              return `${e6.nodeName.toUpperCase()} (${e6.name})`;
            default:
              return e6.nodeName.toUpperCase() + (y4(e6.className) ? `.${e6.className}` : "");
          }
        }(e5[0].target)}`);
      }
      const Pe = /* @__PURE__ */ new WeakSet();
      function Ae(e5) {
        if (e5.nodeType !== Node.ELEMENT_NODE)
          return;
        if (!Pe.has(e5)) {
          const t6 = getComputedStyle(e5)?.position;
          "" !== t6 && "static" !== t6 && (oe.observe(e5), Pe.add(e5));
        }
        const t5 = ke(e5)();
        for (const e6 of t5) {
          if (Pe.has(e6) || e6?.nodeType !== Node.ELEMENT_NODE)
            continue;
          const t6 = getComputedStyle(e6)?.position;
          "" !== t6 && "static" !== t6 && (oe.observe(e6), Pe.add(e6));
        }
      }
      function Ne(e5) {
        performance.mark(E3);
        const t5 = (n4 = e5).charAt(0).toUpperCase() + n4.slice(1);
        var n4;
        let i5 = 0, r5 = document.documentElement, a5 = V2 ? 0 : document.documentElement.getBoundingClientRect().bottom;
        performance.mark(E3);
        const l6 = V2 ? ae : F2 ? te : ke(document)();
        let s7 = l6.length;
        for (const t6 of l6)
          V2 || !g4 || t6.checkVisibility(o5) ? (i5 = t6.getBoundingClientRect()[e5] + parseFloat(getComputedStyle(t6).getPropertyValue(`margin-${e5}`)), i5 > a5 && (a5 = i5, r5 = t6)) : s7 -= 1;
        return O2 = r5, performance.mark(j3, { detail: { Side: t5, len: s7, hasTags: V2, logging: X } }), a5;
      }
      const Ie = (e5) => [e5.bodyOffset(), e5.bodyScroll(), e5.documentElementOffset(), e5.documentElementScroll(), e5.boundingClientRect()], ke = (e5) => () => e5.querySelectorAll("* :not(head):not(meta):not(base):not(title):not(script):not(link):not(style):not(map):not(area):not(option):not(optgroup):not(template):not(track):not(wbr):not(nobr)"), Re = { height: 0, width: 0 }, xe = { height: 0, width: 0 };
      function qe(e5) {
        function t5() {
          return xe[o6] = i5, Re[o6] = l6, i5;
        }
        const n4 = e5 === Le, o6 = n4 ? "height" : "width", i5 = e5.boundingClientRect(), r5 = Math.ceil(i5), a5 = Math.floor(i5), l6 = ((e6) => e6.documentElementScroll() + Math.max(0, e6.getOffset()))(e5);
        switch (true) {
          case !e5.enabled():
            return l6;
          case V2:
            return e5.taggedElement();
          case (!F2 && 0 === xe[o6] && 0 === Re[o6]):
            return t5();
          case (de && i5 === xe[o6] && l6 === Re[o6]):
            return Math.max(i5, l6);
          case 0 === i5:
            return l6;
          case (!F2 && i5 !== xe[o6] && l6 <= Re[o6]):
            return t5();
          case !n4:
            return e5.taggedElement();
          case (!F2 && i5 < xe[o6]):
        ...
        return Math.max(e5.taggedElement(), t5());
      }
      const Le = { enabled: () => D2, getOffset: () => P3, auto: () => qe(Le), bodyOffset: () => {
        const { body: e5 } = document, n4 = getComputedStyle(e5);
        return e5.offsetHeight + parseInt(n4.marginTop, t4) + parseInt(n4.marginBottom, t4);
      }, bodyScroll: () => document.body.scrollHeight, offset: () => Le.bodyOffset(), custom: () => s6.height(), documentElementOffset: () => document.documentElement.offsetHeight, documentElementScroll: () => document.documentElement.scrollHeight, boundingClientRect: () => Math.max(document.documentElement.getBoundingClientRect().bottom, document.body.getBoundingClientRect().bottom), max: () => Math.max(...Ie(Le)), min: () => Math.min(...Ie(Le)), grow: () => Le.max(), lowestElement: () => Ne(i4), taggedElement: () => Ne(i4) }, Be = { enabled: () => W, getOffset: () => A4, auto: () => qe(Be), bodyScroll: () => document.body.scrollWidth, bodyOffset: () => document.body.offsetWidth, custom: () => s6.width(), documentElementScroll: () => document.documentElement.scrollWidth, documentElementOffset: () => document.documentElement.offsetWidth, boundingClientRect: () => Math.max(document.documentElement.getBoundingClientRect().right, document.body.getBoundingClientRect().right), max: () => Math.max(...Ie(Be)), min: () => Math.min(...Ie(Be)), rightMostElement: () => Ne(r4), scroll: () => Math.max(Be.bodyScroll(), Be.documentElementScroll()), taggedElement: () => Ne(r4) }, De = (e5, t5) => !(Math.abs(e5 - t5) <= ce);
      let We = false;
      function Ue(e5, t5, n4, o6, i5) {
        k3 = performance.now(), (R || e5 === a4) && (document.hidden || (We || (I3 = true, function(e6, t6, n5, o7, i6) {
          const r5 = void 0 === n5 ? Le[H]() : n5, l6 = void 0 === o7 ? Be[fe]() : o7;
          D2 && De(J, r5) || W && De(me, l6) || "init" === e6 ? (Fe(), J = r5, me = l6, He(J, me, e6, i6)) : !e6 !== a4 && (D2 && H in T4 || W && fe in T4) ? Je() : I3 = false;
        }(e5, 0, n4, o6, i5), requestAnimationFrame(() => {
          We = false;
        })), We = true));
      }
      function Fe() {
        de || (de = true, requestAnimationFrame(() => {
          de = false;
        }));
      }
      function Ve(e5) {
        J = Le[H](), me = Be[fe](), He(J, me, e5);
      }
      function Je(e5) {
        const t5 = H;
        H = b4, Fe(), Ve("reset"), H = t5;
      }
      function He(e5, t5, n4, o6, i5) {
        Y < -1 || (void 0 !== i5 || (i5 = se), function() {
          const r5 = `${K}:${e5 + (P3 || 0)}:${t5 + (A4 || 0)}:${n4}${void 0 === o6 ? "" : `:${o6}`}`;
          X && (console.group(`[iframe-resizer][${K}]`), console.info("Sending message to host page via " + (ie ? "sameDomain" : "postMessage")), console.info(`%c${r5}`, "font-style: italic"), I3 && console.info(function() {
            const e6 = m2(performance.now() - k3);
            return "init" === n4 ? `Initialised iFrame in %c${e6}ms` : `Content size recalculated in %c${e6}ms`;
          }(), "font-weight:bold;color:#777"), console.groupEnd()), I3 = false, ie ? window.parent.iframeParentListener($3 + r5) : le.postMessage($3 + r5, i5);
        }());
      }
      function Ze(e5) {
        const t5 = { init: function() {
          _5 = e5.data, le = e5.source, N3 = e5.origin, ve(), U = false, setTimeout(() => {
            Z = false;
          }, f5);
        }, reset() {
          Z || Ve("resetPage");
          ...
          const e6 = o6();
          ge ? setTimeout(() => ge(JSON.parse(e6))) : He(0, 0, "pageInfoStop");
        }, parentInfo() {
          const e6 = o6();
          be ? setTimeout(be(Object.freeze(JSON.parse(e6)))) : He(0, 0, "parentInfoStop");
        }, message() {
          const e6 = o6();
          he(JSON.parse(e6));
        } }, n4 = () => e5.data.split("]")[1].split(":")[0], o6 = () => e5.data.slice(e5.data.indexOf(":") + 1), i5 = () => "iframeResize" in window || void 0 !== window.jQuery && "" in window.jQuery.prototype, r5 = () => e5.data.split(":")[2] in { true: 1, false: 1 };
        $3 === `${e5.data}`.slice(0, C4) && (false !== U ? r5() && t5.init() : function() {
          const o7 = n4();
          o7 in t5 ? t5[o7]() : i5() || r5() || v5(`Unexpected message (${e5.data})`);
        }());
      }
      function _e() {
        "loading" !== document.readyState && window.parent.postMessage("[iFrameResizerChild]Ready", "*");
      }
      "iframeChildListener" in window ? v5("Already setup") : (window.iframeChildListener = (e5) => setTimeout(() => Ze({ data: e5, sameDomain: true })), l5(window, "message", Ze), l5(window, "readystatechange", _e), _e());
    }();
  });
  ...
  function M() {
    ...
    for (i.sort(f); n3 = i.shift(); )
      n3.__d && (u4 = i.length, o4 = void 0, e4 = (r4 = (t4 = n3).__v).__e, c4 = [], s5 = [], t4.__P && ((o4 = d({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(o4), O(t4.__P, o4, r4, t4.__n, t4.__P.namespaceURI, 32 & r4.__u ? [e4] : null, c4, null == e4 ? x(r4) : e4, !!(32 & r4.__u), s5), o4.__v = r4.__v, o4.__.__k[o4.__i] = o4, j(c4, o4, s5), o4.__e != e4 && C(o4)), i.length > u4 && i.sort(f));
    M.__r = 0;
  }
  function P(n3, l5, u4, t4, i4, o4, r4, f4, e4, c4, s5) {
    var a4, p4, y4, d5, w4, _5 = t4 && t4.__k || v, g3 = l5.length;
    for (u4.__d = e4, $(u4, l5, _5), e4 = u4.__d, a4 = 0; a4 < g3; a4++)
      null != (y4 = u4.__k[a4]) && (p4 = -1 === y4.__i ? h : _5[y4.__i] || h, y4.__i = a4, O(n3, y4, p4, i4, o4, r4, f4, e4, c4, s5), d5 = y4.__e, y4.ref && p4.ref != y4.ref && (p4.ref && E(p4.ref, null, y4), s5.push(y4.ref, y4.__c || d5, y4)), null == w4 && null != d5 && (w4 = d5), 65536 & y4.__u || p4.__k === y4.__k ? e4 = I(y4, e4, n3) : "function" == typeof y4.type && void 0 !== y4.__d ? e4 = y4.__d : d5 && (e4 = d5.nextSibling), y4.__d = void 0, y4.__u &= -196609);
    u4.__d = e4, u4.__e = w4;
  }
  function $(n3, l5, u4) {
    var t4, i4, o4, r4, f4, e4 = l5.length, c4 = u4.length, s5 = c4, a4 = 0;
    for (n3.__k = [], t4 = 0; t4 < e4; t4++)
      null != (i4 = l5[t4]) && "boolean" != typeof i4 && "function" != typeof i4 ? (r4 = t4 + a4, (i4 = n3.__k[t4] = "string" == typeof i4 || "number" == typeof i4 || "bigint" == typeof i4 || i4.constructor == String ? g(null, i4, null, null, null) : y(i4) ? g(b, { children: i4 }, null, null, null) : void 0 === i4.constructor && i4.__b > 0 ? g(i4.type, i4.props, i4.key, i4.ref ? i4.ref : null, i4.__v) : i4).__ = n3, i4.__b = n3.__b + 1, o4 = null, -1 !== (f4 = i4.__i = L(i4, u4, r4, s5)) && (s5--, (o4 = u4[f4]) && (o4.__u |= 131072)), null == o4 || null === o4.__v ? (-1 == f4 && a4--, "function" != typeof i4.type && (i4.__u |= 65536)) : f4 !== r4 && (f4 == r4 - 1 ? a4-- : f4 == r4 + 1 ? a4++ : (f4 > r4 ? a4-- : a4++, i4.__u |= 65536))) : i4 = n3.__k[t4] = null;
    if (s5)
      for (t4 = 0; t4 < c4; t4++)
        null != (o4 = u4[t4]) && 0 == (131072 & o4.__u) && (o4.__e == n3.__d && (n3.__d = x(o4)), N(o4, o4));
  }
  function I(n3, l5, u4) {
    var t4, i4;
  ...
  function L(n3, l5, u4, t4) {
    ...
    if (null === e4 || e4 && i4 == e4.key && o4 === e4.type && 0 == (131072 & e4.__u))
      return u4;
    if (("function" != typeof o4 || o4 === b || i4) && t4 > (null != e4 && 0 == (131072 & e4.__u) ? 1 : 0))
    ...
    return function(u4) {
      if (this.l) {
        ...
        if (null == u4.t)
          ...
          return;
        return l.event && (u4 = l.event(u4)), "handleEvent" in t4 ? t4.handleEvent(u4) : t4(u4);
      }
    };
  }
  function O(n3, u4, t4, i4, o4, r4, f4, e4, c4, s5) {
    var a4, h4, v5, p4, w4, _5, g3, m2, x3, C3, S2, M2, $2, I2, H, L2, T3 = u4.type;
    ...
    n:
      if ("function" == typeof T3)
        try {
          if (m2 = u4.props, x3 = "prototype" in T3 && T3.prototype.render, C3 = (a4 = T3.contextType) && i4[a4.__c], S2 = a4 ? C3 ? C3.props.value : a4.__ : i4, t4.__c ? g3 = (h4 = u4.__c = t4.__c).__ = h4.__E : (x3 ? u4.__c = h4 = new T3(m2, S2) : (u4.__c = h4 = new k(m2, S2), h4.constructor = T3, h4.render = V), C3 && C3.sub(h4), h4.props = m2, h4.state || (h4.state = {}), h4.context = S2, h4.__n = i4, v5 = h4.__d = true, h4.__h = [], h4._sb = []), x3 && null == h4.__s && (h4.__s = h4.state), x3 && null != T3.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, T3.getDerivedStateFromProps(m2, h4.__s))), p4 = h4.props, w4 = h4.state, h4.__v = u4, v5)
            ...
            if (x3 && null == T3.getDerivedStateFromProps && m2 !== p4 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m2, S2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m2, h4.__s, S2) || u4.__v === t4.__v)) {
            ...
            null != h4.componentWillUpdate && h4.componentWillUpdate(m2, h4.__s, S2), x3 && null != h4.componentDidUpdate && h4.__h.push(function() {
              h4.componentDidUpdate(p4, w4, _5);
            });
          }
          if (h4.context = S2, h4.props = m2, h4.__P = n3, h4.__e = false, $2 = l.__r, I2 = 0, x3) {
            for (h4.state = h4.__s, h4.__d = false, $2 && $2(u4), a4 = h4.render(h4.props, h4.state, h4.context), H = 0; H < h4._sb.length; H++)
          ...
          h4.state = h4.__s, null != h4.getChildContext && (i4 = d(d({}, i4), h4.getChildContext())), x3 && !v5 && null != h4.getSnapshotBeforeUpdate && (_5 = h4.getSnapshotBeforeUpdate(p4, w4)), P(n3, y(L2 = null != a4 && a4.type === b && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u4, t4, i4, o4, r4, f4, e4, c4, s5), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && f4.push(h4), g3 && (h4.__E = h4.__ = null);
        } catch (n4) {
        ...
        null == r4 && u4.__v === t4.__v ? (u4.__k = t4.__k, u4.__e = t4.__e) : u4.__e = z(t4.__e, u4, t4, i4, o4, r4, f4, c4, s5);
    (a4 = l.diffed) && a4(u4);
  }
  function j(n3, u4, t4) {
    u4.__d = void 0;
  ...
  function z(u4, t4, i4, o4, r4, f4, e4, c4, s5) {
    var a4, v5, p4, d5, _5, g3, m2, b3 = i4.props, k3 = t4.props, C3 = t4.type;
    if ("svg" === C3 ? r4 = "http://www.w3.org/2000/svg" : "math" === C3 ? r4 = "http://www.w3.org/1998/Math/MathML" : r4 || (r4 = "http://www.w3.org/1999/xhtml"), null != f4) {
      for (a4 = 0; a4 < f4.length; a4++)
        if ((_5 = f4[a4]) && "setAttribute" in _5 == !!C3 && (C3 ? _5.localName === C3 : 3 === _5.nodeType)) {
          u4 = _5, f4[a4] = null;
          break;
        }
    }
    ...
    if (null === C3)
      ...
      for (a4 in k3)
        _5 = k3[a4], "children" == a4 ? d5 = _5 : "dangerouslySetInnerHTML" == a4 ? v5 = _5 : "value" == a4 ? g3 = _5 : "checked" == a4 ? m2 = _5 : c4 && "function" != typeof _5 || b3[a4] === _5 || A(u4, a4, _5, b3[a4], r4);
      if (v5)
        c4 || p4 && (v5.__html === p4.__html || v5.__html === u4.innerHTML) || (u4.innerHTML = v5.__html), t4.__k = [];
      else if (p4 && (u4.innerHTML = ""), P(u4, y(d5) ? d5 : [d5], t4, i4, o4, "foreignObject" === C3 ? "http://www.w3.org/1999/xhtml" : r4, f4, e4, f4 ? f4[0] : i4.__k && x(i4, 0), c4, s5), null != f4)
        for (a4 = f4.length; a4--; )
          w(f4[a4]);
  ...
  function N(n3, u4, t4) {
    var i4, o4;
    if (l.unmount && l.unmount(n3), (i4 = n3.ref) && (i4.current && i4.current !== n3.__e || E(i4, null, u4)), null != (i4 = n3.__c)) {
  ...
  function D(l5, u4, t4) {
    ...
    for (r4 in l5.type && l5.type.defaultProps && (f4 = l5.type.defaultProps), u4)
  ...
  var isPlainObject = (candidate) => Boolean(candidate && typeof candidate === "object" && candidate.constructor === Object);
  ...
  var PropSignal = class {
    ...
    getComputed() {
      ...
      if (!this.computedsByScope.has(scope)) {
        ...
        this.computedsByScope.set(scope, w3(withScope(callback)));
        resetNamespace();
      }
  ...
  var readOnlyProxies = /* @__PURE__ */ new WeakSet();
  ...
  var proxifyState = (namespace, obj, options) => {
  ...
  var deepMerge = (target, source, override = true) => r3(() => deepMergeRecursive(getObjectFromProxy(target) || target, source, override));
  ...
  var contextHandlers = {
    ...
    ownKeys: (target) => [.../* @__PURE__ */ new Set([...Object.keys(contextObjectToFallback.get(target)), ...Object.keys(target)])],
  ...
  function store(namespace, {
    ...
    if (!stores.has(namespace)) {
      ...
      const rawStore = {
        state: proxifyState(namespace, isPlainObject(state4) ? state4 : {}),
        ...block
      };
  ...
  var populateServerData = (data2) => {
    if (isPlainObject(data2?.state)) {
      Object.entries(data2.state).forEach(([namespace, state4]) => {
        ...
        deepMerge(st.state, state4, false);
        deepMerge(getServerState(namespace), state4);
      });
    }
  ...
  var directives_default = () => {
    directive("context", ({
      ...
      const defaultEntry = context2.find(isDefaultDirectiveSuffix);
      const {
        client: inheritedClient,
        server: inheritedServer
      } = x2(inheritedContext);
      const ns = defaultEntry.namespace;
      const client = A2(proxifyState(ns, {}));
      const server = A2(proxifyState(ns, {}, {
        readOnly: true
      }));
      const contextStack = T2(() => {
        const result = {
          client: {
            ...inheritedClient
          },
...
`;
  ...
  var __classPrivateFieldSet = function(receiver, state4, value, kind2, f4) {
    if (kind2 === "m")
      throw new TypeError("Private method is not writable");
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a setter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind2 === "a" ? f4.call(receiver, value) : f4 ? f4.value = value : state4.set(receiver, value), value;
  };
  var __classPrivateFieldGet = function(receiver, state4, kind2, f4) {
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a getter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind2 === "m" ? f4 : kind2 === "a" ? f4.call(receiver) : f4 ? f4.value : state4.get(receiver);
  };
  ...
  var __classPrivateFieldSet2 = function(receiver, state4, value, kind2, f4) {
    if (kind2 === "m")
      throw new TypeError("Private method is not writable");
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a setter");
  ...
  var __classPrivateFieldGet2 = function(receiver, state4, kind2, f4) {
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a getter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot read private member from an object whose class did not declare it");
  ...
  var AbstractChatCompletionRunner = class {
    ...
    off(event, listener) {
      ...
      if (!listeners)
        return this;
      const index = listeners.findIndex((l5) => l5.listener === listener);
      if (index >= 0)
    ...
    _emit(event, ...args) {
      ...
      const listeners = __classPrivateFieldGet2(this, _AbstractChatCompletionRunner_listeners, "f")[event];
      if (listeners) {
        __classPrivateFieldGet2(this, _AbstractChatCompletionRunner_listeners, "f")[event] = listeners.filter((l5) => !l5.once);
    ...
    async _runFunctions(completions, params, options) {
      ...
      for (let i4 = 0; i4 < maxChatCompletions; ++i4) {
        ...
        if (!fn) {
          const content2 = `Invalid function_call: ${JSON.stringify(name)}. Available options are: ${functions.map((f4) => JSON.stringify(f4.name)).join(", ")}. Please try again`;
    ...
    async _runTools(completions, params, options) {
      ...
      for (let i4 = 0; i4 < maxChatCompletions; ++i4) {
        ...
        for (const tool_call of message.tool_calls) {
          ...
          const fn = functionsByName[name];
          if (!fn) {
            const content2 = `Invalid tool_call: ${JSON.stringify(name)}. Available options are: ${tools.map((f4) => JSON.stringify(f4.function.name)).join(", ")}. Please try again`;
  ...
  var __classPrivateFieldGet3 = function(receiver, state4, kind2, f4) {
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a getter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot read private member from an object whose class did not declare it");
  ...
  var __classPrivateFieldSet3 = function(receiver, state4, value, kind2, f4) {
    if (kind2 === "m")
      throw new TypeError("Private method is not writable");
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a setter");
...
${str(snapshot)}`);
  ...
  var __classPrivateFieldSet4 = function(receiver, state4, value, kind2, f4) {
    if (kind2 === "m")
      throw new TypeError("Private method is not writable");
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a setter");
  ...
  var __classPrivateFieldGet4 = function(receiver, state4, kind2, f4) {
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a getter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot read private member from an object whose class did not declare it");
  ...
  var AbstractAssistantStreamRunner = class {
    ...
    _emit(event, ...args) {
      ...
      const listeners = __classPrivateFieldGet4(this, _AbstractAssistantStreamRunner_listeners, "f")[event];
      if (listeners) {
        __classPrivateFieldGet4(this, _AbstractAssistantStreamRunner_listeners, "f")[event] = listeners.filter((l5) => !l5.once);
        listeners.forEach(({ listener }) => listener(...args));
      }
      if (event === "abort") {
        const error = args[0];
  ...
  var __classPrivateFieldGet5 = function(receiver, state4, kind2, f4) {
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a getter");
    if (typeof state4 === "function" ? receiver !== state4 || !f4 : !state4.has(receiver))
      throw new TypeError("Cannot read private member from an object whose class did not declare it");
  ...
  var __classPrivateFieldSet5 = function(receiver, state4, value, kind2, f4) {
    if (kind2 === "m")
      throw new TypeError("Private method is not writable");
    if (kind2 === "a" && !f4)
      throw new TypeError("Private accessor was defined without a setter");
  ...
  var AssistantChatStore = store("AssistantChat", {
    state: {
      get isLocked() {
        ...
        return (state.isLimitDisabled ? false : state.messageCount >= state.messageLimit) || isLoading;
      },
      get hasError() {
    ...
    actions: {
      ...
      async deleteMessage(id) {
        ...
        ctx.list = ctx.list.filter((i4) => i4.id != id);
      },
  ...
  var AssistantChatMessageStore = store("AssistantChatMessage", {
    ...
    actions: {
      async delete() {
        await AssistantChatStore.actions.deleteMessage(state2.messageId);
      }
    }
  });
  ...
  var AssistantChatFormStore = store("AssistantChatForm", {
    ...
    actions: {
      ...
      submit(e4) {
        ...
        if (msg)
          AssistantChatStore.actions.runChat(msg);
      }
    }
  });
