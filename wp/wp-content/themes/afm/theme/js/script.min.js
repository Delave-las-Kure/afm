(() => {
  ...
  !function(e4) {
    ...
    "use strict";
    const e4 = "5.3.2", t4 = 10, n3 = "data-iframe-size", o5 = "data-overflowed", i5 = "bottom", r4 = "right", a5 = "resizeParent", l6 = (e5, t5, n4, o6) => e5.addEventListener(t5, n4, o6 || false), s6 = ["<iy><yi>Puchspk Spjluzl Rlf</><iy><iy>", "<iy><yi>Tpzzpun Spjluzl Rlf</><iy><iy>", "Aopz spiyhyf pz hchpshisl dpao ivao Jvttlyjphs huk Vwlu-Zvbyjl spjluzlz.<iy><iy><i>Jvttlyjphs Spjluzl</><iy>Mvy jvttlyjphs bzl, <p>pmyhtl-ylzpgly</> ylxbpylz h svd jvza vul aptl spjluzl mll. Mvy tvyl pumvythapvu cpzpa <b>oaawz://pmyhtl-ylzpgly.jvt/wypjpun</>.<iy><iy><i>Vwlu Zvbyjl Spjluzl</><iy>Pm fvb hyl bzpun aopz spiyhyf pu h uvu-jvttlyjphs vwlu zvbyjl wyvqlja aolu fvb jhu bzl pa mvy myll bukly aol alytz vm aol NWS C3 Spjluzl. Av jvumpyt fvb hjjlwa aolzl alytz, wslhzl zla aol <i>spjluzl</> rlf pu <p>pmyhtl-ylzpgly</> vwapvuz av <i>NWSc3</>.<iy><iy>Mvy tvyl pumvythapvu wslhzl zll: <b>oaawz://pmyhtl-ylzpgly.jvt/nws</>", "<i>NWSc3 Spjluzl Clyzpvu</><iy><iy>Aopz clyzpvu vm <p>pmyhtl-ylzpgly</> pz ilpun bzlk bukly aol alytz vm aol <i>NWS C3</> spjluzl. Aopz spjluzl hssvdz fvb av bzl <p>pmyhtl-ylzpgly</> pu Vwlu Zvbyjl wyvqljaz, iba pa ylxbpylz fvby wyvqlja av il wbispj, wyvcpkl haaypibapvu huk il spjluzlk bukly clyzpvu 3 vy shaly vm aol NUB Nlulyhs Wbispj Spjluzl.<iy><iy>Pm fvb hyl bzpun aopz spiyhyf pu h uvu-vwlu zvbyjl wyvqlja vy dlizpal, fvb dpss ullk av wbyjohzl h svd jvza vul aptl jvttlyjphs spjluzl.<iy><iy>Mvy tvyl pumvythapvu cpzpa <b>oaawz://pmyhtl-ylzpgly.jvt/wypjpun</>."];
    Object.fromEntries(["2cgs7fdf4xb", "1c9ctcccr4z", "1q2pc4eebgb", "ueokt0969w", "w2zxchhgqz", "1umuxblj2e5"].map((e5, t5) => [e5, Math.max(0, t5 - 1)]));
    const c5 = (e5) => ((e6) => e6.replaceAll(/[A-Za-z]/g, (e7) => String.fromCodePoint((e7 <= "Z" ? 90 : 122) >= (e7 = e7.codePointAt(0) + 19) ? e7 : e7 - 26)))(s6[e5]), d6 = (e5) => e5, u5 = 1e5, m3 = (e5) => Math.round(e5 * u5) / u5;
    let f5 = "", p6 = false;
    const h4 = (e5) => {
      f5 = e5.id, p6 = e5.logging;
    }, y4 = (e5) => "" != `${e5}` && void 0 !== e5;
    const g4 = (...e5) => [`[iframe-resizer][${f5 || "child"}]`, ...e5].join(" "), b4 = (...e5) => p6 && console?.info(`%c[iframe-resizer][${f5}]%c`, "font-weight: bold;", "font-weight: normal;", ...e5), v6 = (...e5) => console?.warn(g4(...e5)), w5 = (...e5) => console?.warn((/* @__PURE__ */ ((e6) => (t5) => window.chrome ? e6(t5.replaceAll("<br>", "\n").replaceAll("<rb>", "\x1B[31;1m").replaceAll("</>", "\x1B[m").replaceAll("<b>", "\x1B[1m").replaceAll("<i>", "\x1B[3m").replaceAll("<u>", "\x1B[4m")) : e6(t5.replaceAll("<br>", "\n").replaceAll(/<[/a-z]+>/gi, "")))(g4))(...e5)), z3 = (e5) => w5(e5), S2 = (e5) => {
      const t5 = e5.side || i5, n4 = e5.onChange || d6, r5 = { root: e5.root, rootMargin: "0px", threshold: 1 };
      function a6() {
        const e6 = document.querySelectorAll(`[${o5}]`);
        n4(e6);
      }
      const l7 = new IntersectionObserver(function(e6) {
        for (const n5 of e6) {
          const { boundingClientRect: e7, rootBounds: i6, target: r6 } = n5, a7 = e7[t5], l8 = 0 === a7 || a7 > i6[t5];
          r6.toggleAttribute(o5, l8);
        }
        requestAnimationFrame(a6);
      }, r5), s7 = /* @__PURE__ */ new WeakSet();
      return function(e6) {
        for (const t6 of e6)
          t6.nodeType !== Node.ELEMENT_NODE || s7.has(t6) || (l7.observe(t6), s7.add(t6));
      };
    }, E3 = "--ifr-start", j3 = "--ifr-end", $2 = "--ifr-measure", C3 = [], T2 = /* @__PURE__ */ new WeakSet(), M2 = (e5) => "object" == typeof e5 && T2.add(e5);
    let O2 = null, P3 = {};
    const A3 = setInterval(() => {
      if (C3.length < 10)
        return;
      if (P3.hasTags && P3.len < 25)
        return;
      C3.sort();
      const e5 = Math.min(C3.reduce((e6, t5) => e6 + t5, 0) / C3.length, C3[Math.floor(C3.length / 2)]);
      e5 <= 4 || (clearInterval(A3), w5(`<rb>Performance Warning</>

Calculating the page size is taking an excessive amount of time (${m3(e5)}ms).

To improve performance add the <b>data-iframe-size</> attribute to the ${P3.Side.toLowerCase()} most element on the page. For more details see: <u>https://iframe-resizer.com/perf</>.`));
    }, 5e3);
    function N2(e5) {
      e5.getEntries().forEach((e6) => {
        if (e6.name === j3) {
          ...
          !function(e7, t6) {
            const { Side: n4, len: o6, hasTags: i6, logging: r5 } = e7;
            P3 = e7, T2.has(O2) || i6 && o6 <= 1 || (r5 || M2(O2), b4(`
  ${n4} position calculated from:`, O2, `
  Parsed ${o6} ${i6 ? "tagged" : "potentially overflowing"} elements in ${m3(t6)}ms`));
    ...
    "undefined" != typeof document && "undefined" != typeof PerformanceObserver && ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", I2) : I2()), "undefined" != typeof window && function() {
      const o6 = { contentVisibilityAuto: true, opacityProperty: true, visibilityProperty: true }, s7 = { height: () => (v6("Custom height calculation function not defined"), Le.auto()), width: () => (v6("Custom width calculation function not defined"), Be.auto()) }, u6 = { bodyOffset: 1, bodyScroll: 1, offset: 1, documentElementOffset: 1, documentElementScroll: 1, boundingClientRect: 1, max: 1, min: 1, grow: 1, lowestElement: 1 }, f6 = 128, p7 = {}, g5 = "checkVisibility" in window, b5 = "auto", $3 = "[iFrameSizer]", C4 = $3.length, T3 = { max: 1, min: 1, bodyScroll: 1, documentElementScroll: 1 }, M3 = "scroll";
      let P4, A4, N3, I3, k4, R2 = true, x3 = "", q3 = 0, L2 = "", B3 = "", D2 = true, W = false, U = true, F3 = false, V2 = false, J = 1, H = b5, Z = true, _5 = "", Q = {}, X = false, Y = 0, G2 = false, K = "", ee = d6, te = [], ne = "child", oe = null, ie = false, re = "", ae = [], le = window.parent, se = "*", ce = 0, de = false, ue = "", me = 1, fe = M3, pe = window, he = () => {
        v6("onMessage function not defined");
      }, ye = () => {
      }, ge = null, be = null;
      function ve() {
        var o7, d7, u7;
        !function() {
          ...
          K = t5[0], q3 = void 0 === t5[1] ? q3 : Number(t5[1]), W = void 0 === t5[2] ? W : e5(t5[2]), X = void 0 === t5[3] ? X : e5(t5[3]), R2 = void 0 === t5[6] ? R2 : e5(t5[6]), L2 = t5[7], H = void 0 === t5[8] ? H : t5[8], x3 = t5[9], B3 = t5[10], ce = void 0 === t5[11] ? ce : Number(t5[11]), Q.enable = void 0 !== t5[12] && e5(t5[12]), ne = void 0 === t5[13] ? ne : t5[13], fe = void 0 === t5[14] ? fe : t5[14], G2 = void 0 === t5[15] ? G2 : e5(t5[15]), P4 = void 0 === t5[16] ? P4 : Number(t5[16]), A4 = void 0 === t5[17] ? A4 : Number(t5[17]), D2 = void 0 === t5[18] ? D2 : e5(t5[18]), t5[19], ue = t5[20] || ue, Y = void 0 === t5[21] ? Y : Number(t5[21]);
        }(), h4({ id: K, logging: X }), function() {
          function e5(e6) {
            he = e6?.onMessage || he, ye = e6?.onReady || ye, "number" == typeof e6?.offset && (w5("<rb>Deprecated option</>\n\n The <b>offset</> option has been renamed to <b>offsetSize</>. Use of the old name will be removed in a future version of <i>iframe-resizer</>."), D2 && (P4 = e6?.offset), W && (A4 = e6?.offset)), "number" == typeof e6?.offsetSize && (D2 && (P4 = e6?.offsetSize), W && (A4 = e6?.offsetSize)), Object.prototype.hasOwnProperty.call(e6, "sizeSelector") && (re = e6.sizeSelector), se = e6?.targetOrigin || se, H = e6?.heightCalculationMethod || H, fe = e6?.widthCalculationMethod || fe;
          }
          function t5(e6, t6) {
            return "function" == typeof e6 && (s7[t6] = e6, e6 = "custom"), e6;
          }
          if (1 === Y)
            return;
        ...
        }(), Y < 0 ? z3(`${c5(Y + 2)}${c5(2)}`) : ue.codePointAt(0) > 4 || Y < 2 && z3(c5(3)), ue && "" !== ue && "false" !== ue ? ue !== e4 && w5(`<b>Version mismatch</>

The parent and child pages are running different versions of <i>iframe resizer</>.

Parent page: ${ue} - Child page: ${e4}.
`) : w5("<rb>Legacy version detected on parent page</>\n\nDetected legacy version of parent page script. It is recommended to update the parent page to use <b>@iframe-resizer/parent</>.\n\nSee <u>https://iframe-resizer.com/setup/</> for more details.\n"), Te(), Me(), function() {
          let e5 = false;
          const t5 = (t6) => document.querySelectorAll(`[${t6}]`).forEach((o8) => {
            e5 = true, o8.removeAttribute(t6), o8.toggleAttribute(n3, true);
          });
          t5("data-iframe-height"), t5("data-iframe-width"), e5 && w5("<rb>Deprecated Attributes</>\n          \nThe <b>data-iframe-height</> and <b>data-iframe-width</> attributes have been deprecated and replaced with the single <b>data-iframe-size</> attribute. Use of the old attributes will be removed in a future version of <i>iframe-resizer</>.");
        }(), ze(), D2 !== W && (ee = S2({ onChange: we, root: document.documentElement, side: D2 ? i5 : r4 })), 1 !== Y && (pe.parentIframe = Object.freeze({ autoResize: (e5) => (true === e5 && false === R2 ? (R2 = true, Ue("autoResizeEnabled", "Auto Resize enabled")) : false === e5 && true === R2 && (R2 = false), He(0, 0, "autoResize", JSON.stringify(R2)), R2), close() {
          He(0, 0, "close");
        }, getId: () => K, getOrigin: () => N3, getPageInfo(e5) {
          if ("function" == typeof e5)
            return ge = e5, He(0, 0, "pageInfo"), void w5("<rb>Deprecated Method</>\n          \nThe <b>getPageInfo()</> method has been deprecated and replaced with  <b>getParentProps()</>. Use of this method will be removed in a future version of <i>iframe-resizer</>.\n");
          ...
          function o8(e6) {
            ...
            const o9 = e6.split("#")[1] || e6, i7 = decodeURIComponent(o9), r6 = document.getElementById(i7) || document.getElementsByName(i7)[0];
            void 0 === r6 ? He(0, 0, "inPageLink", `#${o9}`) : t5(r6);
          }
          function i6() {
          ...
          function r5() {
            for (const e6 of document.querySelectorAll('a[href^="#"]'))
              "#" !== e6.getAttribute("href") && l6(e6, "click", (t5) => {
                t5.preventDefault(), o8(e6.getAttribute("href"));
              });
          }
          function a6() {
            l6(window, "hashchange", i6);
          }
          function s8() {
            setTimeout(i6, f6);
          }
          ...
          return Q.enable && (1 === Y ? w5("In page linking requires a Professional or Business license. Please see https://iframe-resizer.com/pricing for more details.") : c6()), { findTarget: o8 };
        }(), Se(ke(document)()), void 0 === L2 && (L2 = `${q3}px`), Ee("margin", (d7 = "margin", (u7 = L2).includes("-") && (v6(`Negative CSS value ignored for ${d7}`), u7 = ""), u7)), Ee("background", x3), Ee("padding", B3), function() {
        ...
        }(), je(), Ue("init", "Init message from host page", void 0, void 0, e4), document.title && "" !== document.title && He(0, 0, "title", document.title), $e({ method: o7 = "add", eventType: "After Print", eventName: "afterprint" }), $e({ method: o7, eventType: "Before Print", eventName: "beforeprint" }), $e({ method: o7, eventType: "Ready State Change", eventName: "readystatechange" }), function() {
          const e5 = /* @__PURE__ */ new Set();
          let t5 = false, n4 = 0, o8 = [];
          const i6 = (t6) => {
            for (const n5 of t6) {
              const { addedNodes: t7, removedNodes: o9 } = n5;
              for (const n6 of t7)
                e5.add(n6);
              for (const t8 of o9)
                e5.delete(t8);
          ...
          let s8 = 1;
          function c6() {
            const d9 = performance.now(), u9 = d9 - n4;
            if (u9 > r5 * s8++ + a6 && u9 < l7)
              return setTimeout(c6, r5 * s8), void (n4 = d9);
            s8 = 1, o8.forEach(i6), o8 = [], 0 !== e5.size ? (je(), ze(), Se(e5), e5.forEach(Ae), e5.clear(), t5 = false) : t5 = false;
          }
          function d8(e6) {
            o8.push(e6), t5 || (n4 = performance.now(), t5 = true, requestAnimationFrame(c6));
          }
          function u8() {
            const e6 = new window.MutationObserver(d8), t6 = document.querySelector("body"), n5 = { attributes: false, attributeOldValue: false, characterData: false, characterDataOldValue: false, childList: true, subtree: true };
      ...
      function we(e5) {
        te = e5, F3 = te.length > 0, Ue("overflowChanged", "Overflow updated");
      }
      function ze() {
      ...
      function $e(e5) {
        ({ add(t5) {
          ...
          p7[t5] = n4, l6(window, t5, n4, { passive: true });
        }, remove(e6) {
          const t5 = p7[e6];
          var n4, o7;
          delete p7[e6], n4 = e6, o7 = t5, window.removeEventListener(n4, o7, false);
        } })[e5.method](e5.eventName);
      }
      function Ce(e5, t5, n4, o7) {
        return t5 !== e5 && (e5 in n4 || (v6(`${e5} is not a valid option for ${o7}CalculationMethod.`), e5 = t5), e5 in u6 && w5(`<rb>Deprecated ${o7}CalculationMethod (${e5})</>

This version of <i>iframe-resizer</> can auto detect the most suitable ${o7} calculation method. It is recommended that you remove this option.`)), e5;
      }
      function Te() {
        H = Ce(H, b5, Le, "height");
      }
      ...
      function Ne(e5) {
        ...
        var n4;
        let i6 = 0, r5 = document.documentElement, a6 = V2 ? 0 : document.documentElement.getBoundingClientRect().bottom;
        performance.mark(E3);
        const l7 = V2 ? ae : F3 ? te : ke(document)();
        let s8 = l7.length;
        for (const t6 of l7)
          V2 || !g5 || t6.checkVisibility(o6) ? (i6 = t6.getBoundingClientRect()[e5] + parseFloat(getComputedStyle(t6).getPropertyValue(`margin-${e5}`)), i6 > a6 && (a6 = i6, r5 = t6)) : s8 -= 1;
        return O2 = r5, performance.mark(j3, { detail: { Side: t5, len: s8, hasTags: V2, logging: X } }), a6;
      }
      ...
      function qe(e5) {
        function t5() {
          return xe[o7] = i6, Re[o7] = l7, i6;
        }
        const n4 = e5 === Le, o7 = n4 ? "height" : "width", i6 = e5.boundingClientRect(), r5 = Math.ceil(i6), a6 = Math.floor(i6), l7 = ((e6) => e6.documentElementScroll() + Math.max(0, e6.getOffset()))(e5);
        switch (true) {
          case !e5.enabled():
            return l7;
          case V2:
            return e5.taggedElement();
          case (!F3 && 0 === xe[o7] && 0 === Re[o7]):
            return t5();
          case (de && i6 === xe[o7] && l7 === Re[o7]):
            return Math.max(i6, l7);
          case 0 === i6:
            return l7;
          case (!F3 && i6 !== xe[o7] && l7 <= Re[o7]):
            return t5();
          case !n4:
            return e5.taggedElement();
          case (!F3 && i6 < xe[o7]):
      ...
      const Le = { enabled: () => D2, getOffset: () => P4, auto: () => qe(Le), bodyOffset: () => {
        const { body: e5 } = document, n4 = getComputedStyle(e5);
        return e5.offsetHeight + parseInt(n4.marginTop, t4) + parseInt(n4.marginBottom, t4);
      }, bodyScroll: () => document.body.scrollHeight, offset: () => Le.bodyOffset(), custom: () => s7.height(), documentElementOffset: () => document.documentElement.offsetHeight, documentElementScroll: () => document.documentElement.scrollHeight, boundingClientRect: () => Math.max(document.documentElement.getBoundingClientRect().bottom, document.body.getBoundingClientRect().bottom), max: () => Math.max(...Ie(Le)), min: () => Math.min(...Ie(Le)), grow: () => Le.max(), lowestElement: () => Ne(i5), taggedElement: () => Ne(i5) }, Be = { enabled: () => W, getOffset: () => A4, auto: () => qe(Be), bodyScroll: () => document.body.scrollWidth, bodyOffset: () => document.body.offsetWidth, custom: () => s7.width(), documentElementScroll: () => document.documentElement.scrollWidth, documentElementOffset: () => document.documentElement.offsetWidth, boundingClientRect: () => Math.max(document.documentElement.getBoundingClientRect().right, document.body.getBoundingClientRect().right), max: () => Math.max(...Ie(Be)), min: () => Math.min(...Ie(Be)), rightMostElement: () => Ne(r4), scroll: () => Math.max(Be.bodyScroll(), Be.documentElementScroll()), taggedElement: () => Ne(r4) }, De = (e5, t5) => !(Math.abs(e5 - t5) <= ce);
      let We = false;
      function Ue(e5, t5, n4, o7, i6) {
        k4 = performance.now(), (R2 || e5 === a5) && (document.hidden || (We || (I3 = true, function(e6, t6, n5, o8, i7) {
          const r5 = void 0 === n5 ? Le[H]() : n5, l7 = void 0 === o8 ? Be[fe]() : o8;
          D2 && De(J, r5) || W && De(me, l7) || "init" === e6 ? (Fe(), J = r5, me = l7, He(J, me, e6, i7)) : !e6 !== a5 && (D2 && H in T3 || W && fe in T3) ? Je() : I3 = false;
        }(e5, 0, n4, o7, i6), requestAnimationFrame(() => {
          We = false;
        })), We = true));
      }
      function Fe() {
      ...
      function Je(e5) {
        const t5 = H;
        H = b5, Fe(), Ve("reset"), H = t5;
      }
      function He(e5, t5, n4, o7, i6) {
        Y < -1 || (void 0 !== i6 || (i6 = se), function() {
          const r5 = `${K}:${e5 + (P4 || 0)}:${t5 + (A4 || 0)}:${n4}${void 0 === o7 ? "" : `:${o7}`}`;
          X && (console.group(`[iframe-resizer][${K}]`), console.info("Sending message to host page via " + (ie ? "sameDomain" : "postMessage")), console.info(`%c${r5}`, "font-style: italic"), I3 && console.info(function() {
            const e6 = m3(performance.now() - k4);
            return "init" === n4 ? `Initialised iFrame in %c${e6}ms` : `Content size recalculated in %c${e6}ms`;
          }(), "font-weight:bold;color:#777"), console.groupEnd()), I3 = false, ie ? window.parent.iframeParentListener($3 + r5) : le.postMessage($3 + r5, i6);
        }());
      }
      function Ze(e5) {
        const t5 = { init: function() {
          ...
          const e6 = o7();
          he(JSON.parse(e6));
        } }, n4 = () => e5.data.split("]")[1].split(":")[0], o7 = () => e5.data.slice(e5.data.indexOf(":") + 1), i6 = () => "iframeResize" in window || void 0 !== window.jQuery && "" in window.jQuery.prototype, r5 = () => e5.data.split(":")[2] in { true: 1, false: 1 };
        $3 === `${e5.data}`.slice(0, C4) && (false !== U ? r5() && t5.init() : function() {
          const o8 = n4();
          o8 in t5 ? t5[o8]() : i6() || r5() || v6(`Unexpected message (${e5.data})`);
        }());
      }
      function _e() {
        "loading" !== document.readyState && window.parent.postMessage("[iFrameResizerChild]Ready", "*");
      }
      "iframeChildListener" in window ? v6("Already setup") : (window.iframeChildListener = (e5) => setTimeout(() => Ze({ data: e5, sameDomain: true })), l6(window, "message", Ze), l6(window, "readystatechange", _e), _e());
    }();
  });
